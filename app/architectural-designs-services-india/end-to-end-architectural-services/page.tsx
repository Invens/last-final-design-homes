...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Top Architects in Delhi - NCR | Best Architectural Brand'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="We are a top architectural company, we design complete building, interiors, residences, farmhouses, villas, bunglows & structures across Delhi, gurgaon, noida - India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/top-architects-in-india/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/top-architects-in-india/"
          />
          <meta
            property="og:title"
            content="Top Architects in Delhi - NCR | Best Architectural Brand"
          />
          <meta
