...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [138] // Add the category IDs you want to fetch
  ...
  const [title, setTitle] = useState(
    'Luxury Kitchen | Top Wardrobe Manufacturing Brand India'
  )
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>Luxury Kitchen | Top Wardrobe Manufacturing Brand India</title>
        ...
        <div className="p-4  ">
          ...
          /{' '}
          <span className="text-green-500 text-sm">
            <Link href="/luxury-residence">Luxury Residence</Link>
          </span>{' '}
          / <span className="text-gray-600 text-sm">Luxury Kitchen</span>
        </div>
