...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [139] // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>
           Luxury structural | Top Wardrobe Manufacturing Brand India
          </title>
        ...
        <div className="p-4  ">
          ...
          /{' '}
          <span className="text-green-500 text-sm">
            <Link href="/luxury-structural">Luxury Structural</Link>
          </span>{' '}
