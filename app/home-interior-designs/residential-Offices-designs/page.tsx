...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [125] // Add the category IDs you want to fetch
  ...
  const [title, setTitle] = useState(
    'Residential office Design | Residentail Interiors in Delhi - NCR'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Residential office</span>
        </div>
