...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [145] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>Cane Wardrobe Designs | Cane Wardrobes in Delhi - India</title>
      </head>
      <ProgressBar />
      <Omsairam />
      <Header />
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="We have some of the top cane wardrobe designs across Delhi, gurgaon, noida and India, we are the largest manufacturers for cane wardrobes across Delhi - India."
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/types-of-wardrobe/cane-wardrobe-designs-dealers-manufacturers-in-delhi-gurgaon-noida-india/"
          />
          ...
          <meta
            property="og:title"
            content="Cane Wardrobe Designs | Cane Wardrobes in Delhi - India"
          />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Cane Wardrobe</span>
        </div>
