...
const Page = () => {
  ...
  return (
    <>
      <head>
        <title>
          CNC Wardrobe Designs | CNC Designed Wardrobes in Delhi - India
        </title>
        <meta
          name="description"
          content="We have some of the top CNC designed cut wardrobe designs across Delhi, gurgaon, noida and India, we are the largest manufacturers for CNC wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/cnc-designer-wardrobe-designs-dealers-manufacturers-in-delhi-gurgaon-noida-india/"
        />
        ...
        <meta
          property="og:title"
          content="CNC Wardrobe Designs | CNC Designed Wardrobes in Delhi - India"
        />
