...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [127] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>
          Three Door Sliding Wardrobe Designs | Wardrobe Designs Delhi - India
        </title>
        <meta
          name="description"
          content="We have some of the top 3 door sliding wardrobe designs across delhi, gurgaon, noida and India, we are the largest manufacturers for wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/3-door-sliding-wardrobe-designs/"
        />
        ...
        <meta
          property="og:title"
          content="Three Door Sliding Wardrobe Designs | Wardrobe Designs Delhi - India"
        />
        <meta
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">3 Door Sliding</span>
        </div>
