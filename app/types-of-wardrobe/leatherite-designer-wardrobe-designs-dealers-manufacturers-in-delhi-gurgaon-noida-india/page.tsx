...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [147] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>
          Leatherette Wardrobe Designs | Leatherette Designed Wardrobes in Delhi
          - India
        </title>
        <meta
          name="description"
          content="We have some of the top leatherette designed wardrobe designs across Delhi, gurgaon, noida and India, we are the largest manufacturers for leatherette wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/leatherite-designer-wardrobe-designs-dealers-manufacturers-in-delhi-gurgaon-noida-india/"
        />
        ...
        <meta
          property="og:title"
          content="Leatherette Wardrobe Designs | Leatherette Designed Wardrobes in Delhi - India"
        />
