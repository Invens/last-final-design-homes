...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [132] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>
          Membrane Wardrobe Designs | Membrane Wardrobes in Delhi - India
        </title>
        <meta
          name="description"
          content="We have some of the top membrane wardrobe designs across delhi, gurgaon, noida and India, we are the largest manufacturers for membrane wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/membrane-wardrobe-designs/"
        />
        ...
        <meta
          property="og:title"
          content="Membrane Wardrobe Designs | Membrane Wardrobes in Delhi - India"
        />
        <meta
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Membrane Wardrobe</span>
        </div>
