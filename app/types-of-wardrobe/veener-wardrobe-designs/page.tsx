...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [135] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>
          Veneer Wardrobe Designs | Veneer Wardrobes in Delhi - India
        </title>
        <meta
          name="description"
          content="We have some of the top veneer wardrobe designs across Delhi, gurgaon, noida and India, we are the largest manufacturers for veneer wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/veener-wardrobe-designs/"
        />
        ...
        <meta
          property="og:title"
          content="Veneer Wardrobe Designs | Veneer Wardrobes in Delhi - India"
        />
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Veener Wardrobe</span>
        </div>
