...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [136] // Add the category IDs you want to fetch
  ...
  return (
    <>
      <head>
        <title>
          Walk-in Wardrobe Designs | Walk-in Wardrobes in Delhi - India
        </title>
        <meta
          name="description"
          content="We have some of the top walk in wardrobe designs across Delhi, gurgaon, noida and India, we are the largest manufacturers for walk in wardrobes across Delhi - India."
        />
        ...
        <link
          rel="canonical"
          href="https://designindianhomes.com/types-of-wardrobe/walk-in-wardrobe-designs/"
        />
        ...
        <meta
          property="og:title"
          content="Walk-in  Wardrobe Designs | Walk-in Wardrobes in Delhi - India"
        />
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Walk in wardrobe</span>
        </div>
