...
const Page = ({ images, initialSlide, onClose, onNextSlide, onPrevSlide }) => {
  ...
  return (
    <div className="fixed top-12 bottom-0 left-0 right-0 items-center justify-center z-50 flex  bg-black bg-opacity-75">
        ...
        <div className="relative w-full md:w-[60%] lg:w-[700px]  md:h-[80vh] md:flex-shrink-0 mt-24 sm:mt-0">
          <Slider {...sliderSettings} ref={sliderRef}>
            {images.map((image) => (
              <div
                key={image.id}
                className="h-[25vh] md:h-[80vh]  md:rounded-l-lg overflow-hidden"
              >
                <Image
                  width={1000}
                  height={1000}
