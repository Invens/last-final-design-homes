    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <Head>
          ...
          <meta
            name="description"
            content="Our brand is a top interior designing & architectural brand, we design, plan & execute beautiful Studio Apartment Interiors across Delhi, gurgaon, noida & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/studio-apartment-interior-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/studio-apartment-interior-designs/"
          />
          <meta
            property="og:title"
            content="Studio Apartment Interior Designs | Studio Interiors India"
          />
          <meta
