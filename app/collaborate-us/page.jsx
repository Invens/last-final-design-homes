  ...
  return (
    <>
      ...
      <div className="absolute z-10 text-white text-center bg-black/40 px-8 py-6 rounded backdrop-blur-sm">
        <h1 className="sm:text-4xl text-2xl font-bold "> <span className='text-red-700'>Collaborate </span> Collaborate With Us</h1>
      ...
      >
        ...
        <p className="text-md font-bold text-center mt-8">
        ...
        <p className='text-md font-bold text-center mb-16'>We Invite Certified Architects, Professional Interior Designers, Builders to Collaborate with Our Brand and Work Together to ensure smooth coordinations and deliveries in Our Projects.</p>
      </div>
