    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <Head>
          ...
          <meta
            name="description"
            content="Our brand is the largest manufacturer of corian and wooden mandirs, we are top dealers and suppliers for mandirs across Delhi, gurgaon, noida & India."
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/mandir-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/mandir-designs/"
          />
          <meta
            property="og:title"
            content="Mandir Designs | Mandir Manufacturing Company India"
          />
          <meta
