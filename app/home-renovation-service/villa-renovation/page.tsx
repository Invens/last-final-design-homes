...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [40]; // Add the category IDs you want to fetch
...
<meta name="description" content ="We are a top interior designing & architectural brand, we renovate complete villas as per architect designs across Delhi - Gurgaon, Noida, Faridabad, India" />
...
<link rel="canonical" href="https://designindianhomes.com/villa-renovation-services/" />
...
<meta property="og:url" content="https://designindianhomes.com/villa-renovation-services/" />
<meta property="og:title" content="Villa Renovation Services | Villa Renovation India" />
<meta property="og:description" content="We are a top interior designing & architectural brand, we renovate complete villas as per architect designs across Delhi - Gurgaon, Noida, Faridabad, India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Villa Renovation</span>
        </div>
