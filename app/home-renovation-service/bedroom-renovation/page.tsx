...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [28]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Bedroom Renovation Services | Bedroom Makeovers India</title>

<meta name="description" content ="We renovate and design beautiful bedrooms to refresh at most affordable quotes across Delhi, gurgaon, noida, faridabad - India" />
...
<link rel="canonical" href="https://designindianhomes.com/bedroom-renovation-services/" />
...
<meta property="og:url" content="https://designindianhomes.com/bedroom-renovation-services/" />
<meta property="og:title" content="Bedroom Renovation Services | Bedroom Makeovers India" />
<meta property="og:description" content="We renovate and design beautiful bedrooms to refresh at most affordable quotes across Delhi, gurgaon, noida, faridabad - India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Bedroom Renovation</span>
        </div>
