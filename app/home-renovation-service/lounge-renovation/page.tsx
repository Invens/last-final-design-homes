...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [29]; // Add the category IDs you want to fetch
...
<meta name="description" content ="We renovate and design stunning lounge areas to unwind at most affordable prices across Delhi, gurgaon, noida, faridabad - India" />
...
<link rel="canonical" href="https://designindianhomes.com/lounge-renovation-services/" />
...
<meta property="og:url" content="https://designindianhomes.com/lounge-renovation-services/" />
<meta property="og:title" content="Lounge Renovation Services | Lounge Makeovers India" />
<meta property="og:description" content="We renovate and design stunning lounge areas to unwind at most affordable prices across Delhi, gurgaon, noida, faridabad - India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Lounge Renovation</span>
        </div>
