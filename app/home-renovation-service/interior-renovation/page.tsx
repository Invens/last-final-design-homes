  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>
            Interior Renovation Services | Top Interior Designing Brand
          </title>

          <meta
            name="description"
            content="We are a top interior designing brand, we renovate complete end to end interiors across Delhi, Gurgaon, Noida, Faridabad - India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/interior-renovation-services/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/interior-renovation-services/"
          />
          <meta
            property="og:title"
            content="Interior Renovation Services | Top Interior Designing Brand"
          />
          <meta
