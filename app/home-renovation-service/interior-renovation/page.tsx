...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [27]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Interior Renovation Services | Top Interior Designing Brand</title>

<meta name="description" content ="We are a top interior designing brand, we renovate complete end to end interiors across Delhi, Gurgaon, Noida, Faridabad - India" />
...
<link rel="canonical" href="https://designindianhomes.com/interior-renovation-services/" />
...
<meta property="og:url" content="https://designindianhomes.com/interior-renovation-services/" />
<meta property="og:title" content="Interior Renovation Services | Top Interior Designing Brand"/>
<meta property="og:description" content="We are a top interior designing brand, we renovate complete end to end interiors across Delhi, Gurgaon, Noida, Faridabad - India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Interior Renovation</span>
        </div>
