  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>
            Hotel Renovation | Hotel Interior Renovation - Delhi - NCR
          </title>

          <meta
            name="description"
            content="We are a top interior designing & architectural brand, we renovate hotel interiors & structures as per architect designs across Delhi, gurgaon, noida, India."
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/hotel-renovation-services/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/hotel-renovation-services/"
          />
          <meta
            property="og:title"
            content="Hotel Renovation | Hotel Interior Renovation - Delhi - NCR"
          />
          <meta
