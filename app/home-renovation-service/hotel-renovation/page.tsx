...
const Page = ({ }) => {
  ...
  useEffect(() => {
    const categoryIds = [37]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
          <title>Hotel Renovation | Hotel Interior Renovation - Delhi - NCR</title>

          <meta name="description" content="We are a top interior designing & architectural brand, we renovate hotel interiors & structures as per architect designs across Delhi, gurgaon, noida, India." />
          ...
          <link rel="canonical" href="https://designindianhomes.com/hotel-renovation-services/" />
          ...
          <meta property="og:url" content="https://designindianhomes.com/hotel-renovation-services/" />
          <meta property="og:title" content="Hotel Renovation | Hotel Interior Renovation - Delhi - NCR" />
          <meta property="og:description" content="We are a top interior designing & architectural brand, we renovate hotel interiors & structures as per architect designs across Delhi, gurgaon, noida, India." />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Hotel Renovation</span>
        </div>
