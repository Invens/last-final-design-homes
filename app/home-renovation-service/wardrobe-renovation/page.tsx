...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [34]; // Add the category IDs you want to fetch
...
<meta name="description" content ="We are a top modular interior designing & manufacturing brand, we renovate complete wardrobe designs across Delhi, gurgaon, noida, faridabad & India" />
...
<link rel="canonical" href="https://designindianhomes.com/wardrobe-renovation-services/" />
...
<meta property="og:url" content="https://designindianhomes.com/wardrobe-renovation-services/" />
<meta property="og:title" content="Wardrobe Renovation Services | Modular Wardrobe Designs" />
<meta property="og:description" content="We are a top modular interior designing & manufacturing brand, we renovate complete wardrobe designs across D
elhi, gurgaon, noida, faridabad & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Wardrobe Renovation</span>
        </div>
