...
const Page = ({ }) => {
  ...
  useEffect(() => {
    const categoryIds = [30]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
          <title>Bathroom Renovation Services | Bathroom Makeovers India</title>

          <meta name="description" content="We renovate and design beautiful bathrooms at most affordable prices across Delhi, gurgaon, noida, faridabad - India" />
          ...
          <link rel="canonical" href="https://designindianhomes.com/bathroom-renovation-services/" />
          ...
          <meta property="og:url" content="https://designindianhomes.com/bathroom-renovation-services/" />
          <meta property="og:title" content="Bathroom Renovation Services | Bathroom Makeovers India" />
          <meta property="og:description" content="We renovate and design beautiful bathrooms at most affordable prices across Delhi, gurgaon, noida, faridabad - India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Bathroom Renovation</span>
        </div>
