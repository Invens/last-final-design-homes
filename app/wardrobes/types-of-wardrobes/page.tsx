...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [94] // Add the category IDs you want to fetch
  ...
  const [title, setTitle] = useState(
    'Wardrobe Types | Top Wardrobe Manufacturing Brand India'
  )
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>Wardrobe Types | Top Wardrobe Manufacturing Brand India</title>
