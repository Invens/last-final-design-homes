...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [140] // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <Head>
          <title>
           Wardrobe before after | Top Wardrobe Manufacturing Brand India
          </title>
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Before After Wardrobe</span>
        </div>
