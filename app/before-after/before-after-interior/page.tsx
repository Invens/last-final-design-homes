...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [144] // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <Head>
          <title>
            Before after interior | Top Wardrobe Manufacturing Brand India
          </title>
        ...
        <div className="p-4  ">
          ...
          /{' '}
          <span className="text-green-500 text-sm">
            <Link href="/before-after">Before After Designs</Link>
          </span>{' '}
          / <span className="text-gray-600 text-sm">Before After Interior</span>
        </div>
