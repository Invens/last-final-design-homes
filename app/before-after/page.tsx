...
const Page = ({}) => {
  ...
  const categoryFolderMapping: Record<number, string> = {
    140: 'before-after-wardrobe',
    143: 'before-after-kitchen',
    144: 'before-after-interior',
...
"
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Before After Design</span>
        </div>

        <div className="flex items-center  p-4">
          <div className="w-1 h-8 rounded bg-green-500 mr-2"></div>
          <h1 className="text-3xl font-bold">Before After Designs</h1>
        </div>
