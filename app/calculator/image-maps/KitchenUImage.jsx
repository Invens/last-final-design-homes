...
const SvgMap = ({ data, name }) => {
  ...
  const pricing = {
    premium: {
      ...
      'Wall Cabinets Panel 3': { pricePerSqFt: 1500 },
      'Loft Cabinets Panel 3': { pricePerSqFt: 1500 },
    ...
    luxury: {
      ...
      'Base Cabinets Panel 3': { pricePerSqFt: 1800 },
      'Wall Cabinets Panel 3': { pricePerSqFt: 1800 },
      'Loft Cabinets Panel 3': { pricePerSqFt: 1800 },
    ...
    ultraLuxury: {
      ...
      'Base Cabinets Panel 3': { pricePerSqFt: 2500 },
      'Wall Cabinets Panel 3': { pricePerSqFt: 2500 },
      'Loft Cabinets Panel 3': { pricePerSqFt: 2500 },
  ...
  const initialSquareFootage = {
    ...
    KitchenWalls: 196,
    KitchenCabinets: 50,
    'Base Cabinets Panel 1': 18,
    'Wall Cabinets Panel 1': 18,
    'Loft Cabinets Panel 1': 18,
    'Base Cabinets Panel 2': 18,
    'Wall Cabinets Panel 2': 18,
    'Loft Cabinets Panel 2': 18,
    'Base Cabinets Panel 3': 18,
    'Wall Cabinets Panel 3': 18,
    'Loft Cabinets Panel 3': 18,
  }
