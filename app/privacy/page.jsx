...
<div className='text-center'>India&apos;s No.1 Homes Designer Brand</div>
...
<p className='mt-2'>
You are advised to read this Policy carefully. By accessing the services provided by designindiankitchen.com you agree to the collection and use of your data by designindiankitchen.com and certain authorized third party service providers in the manner provided in this Policy. If you do not agree with this Policy, please do not use the Website.
</p>
<h2 className='text-xl font-bold uppercase mt-4'>
What is covered in this Policy?
</h2>
<p className='mt-2'>
This Policy covers how Design Indian Kitchen Company treats personal information that Design Indian Kitchen collects and receives, including information related to your past use of the Website products and services.
</p>
<p className='mt-2'>
...
<p className='mt-2'>
Design Indian Kitchen Company is not responsible for any acts, deeds or things done or committed by any person not being directly employed by Design Indian Kitchen. In addition, certain designindiankitchen.com associated/partner companies have their own privacy statements which can be viewed by clicking on their respective links.
</p>
<h1 className='text-xl font-bold uppercase mt-4'>
Privacy – Our Commitment
</h1>
<p className='mt-2'>
At Design Indian Homes Company, we are extremely committed to protect your privacy. We would like you to feel confident about us, use our services freely and recommend our services to your friends and family.
</p>
<p className='mt-2'>
...
<h2 className='text-xl font-bold uppercase mt-4'>Interpretation and Definitions</h2>
<h3>Interpretation</h3>
<p>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
<h3 className='text-xl font-bold uppercase mt-4'>Definitions</h3>
<p className='text-xl font-bold uppercase mt-4'>For the purposes of this Privacy Policy:</p>
<ul>
<li>
<p  className='mt-4'><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</p>
</li>
<li>
<p><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where &quot;control&quot; means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Design Indian kitchen, 25/42, A BLOCK, MIDDLE CIRCLE, CONNAUGHT PLACE, NEW DELHI - 110001 ( NEAR RAJIV CHOWK METRO STN, GATE NO.8 ).</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Design Indian Homes, accessible from <a href="https://designindianhomes.com" rel="external nofollow noopener" target="_blank">https://designindianhomes.com</a></p>
</li>
<li>
<p><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
</li>
</ul>
<h2 className='text-xl font-bold uppercase mt-4'>Collecting and Using Your Personal Data</h2>
...
<h4 className='text-xl font-bold uppercase mt-4' id='legal'>Usage Data</h4>
...
<h4 className='text-xl font-bold uppercase mt-4'>Tracking Technologies and Cookies</h4>
...
<p className='text-xl font-bold uppercase mt-4'>We use both Session and Persistent Cookies for the purposes set out below:</p>
<ul>
<li>
...
<h3 className='text-xl font-bold uppercase mt-4'>Use of Your Personal Data</h3>
...
<h3 className='text-xl font-bold uppercase mt-4'>Retention of Your Personal Data</h3>
...
<h3 className='text-xl font-bold uppercase mt-4'>Transfer of Your Personal Data</h3>
...
<h3 className='text-xl font-bold uppercase mt-4'>Delete Your Personal Data</h3>
...
<h3 className='text-xl font-bold uppercase mt-4'>Disclosure of Your Personal Data</h3>
<h4 className='text-xl font-bold uppercase mt-2'>Business Transactions</h4>
<p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
<h4>Law enforcement</h4>
<p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
<h4 className='text-xl font-bold uppercase mt-4'>Other legal requirements</h4>
...
<h3 className='text-xl font-bold uppercase mt-4'>Security of Your Personal Data</h3>
<p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
<h2 className='text-xl font-bold uppercaase mt-4'>Children&apos;s Privacy</h2>
...
<h2 className='text-xl font-bold uppercase mt-4'>Links to Other Websites</h2>
<p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party&apos;s site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
<p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
<h2 className='text-xl font-bold uppercase mt-4'>Changes to this Privacy Policy</h2>
...
<ul>
<li>By email: contact@designindianhomes.com</li>
</ul>
  </div>
)
