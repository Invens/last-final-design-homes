...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Wall Panelling Designs | Wall Panelling in Delhi - NCR India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable wall panelling works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/wall-panelling-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/wall-panelling-designs/"
          />
          <meta
            property="og:title"
            content="Wall Panelling Designs | Wall Panelling in Delhi - NCR India"
          />
          <meta
