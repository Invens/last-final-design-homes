...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Bed Designs | Bed Dealers & Manufacturers in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is largest dealer & manufacturer for wooden bed works across Delhi - NCR & India, get it touch for most affordable storage bed."
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/bed-designs-dealers-manufacturers-india-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/bed-designs-dealers-manufacturers-india-designs/"
          />
          <meta
            property="og:title"
            content="Bed Designs | Bed Dealers & Manufacturers in Delhi - India"
          />
          <meta
