...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Sofa Designs | Sofa Dealers & Manufacturers in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is largest manufacturer for sofas and custom furniture, we deal in affordable sofa works across Delhi - NCR & India."
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/sofa-designs-ideas/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/sofa-designs-ideas/"
          />
          <meta
            property="og:title"
            content="Sofa Designs | Sofa Dealers & Manufacturers in Delhi - India"
          />
          <meta
