...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Exterior Cladding Designs | Exterior Cladding in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable exterior cladding works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/exterior-cladding-design-ideas-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/exterior-cladding-design-ideas-designs/"
          />
          <meta
            property="og:title"
            content="Exterior Cladding Designs | Exterior Cladding in Delhi - India"
          />
          <meta
