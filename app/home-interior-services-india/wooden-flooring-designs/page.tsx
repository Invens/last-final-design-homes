...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Wooden Flooring Designs | Wood Flooring Works in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is Best interior designing, architectural & Civil contractual brand, we execute affordable wooden flooring works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/wooden-flooring-designs-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/wooden-flooring-designs-designs/"
          />
          <meta
            property="og:title"
            content="Wooden Flooring Designs | Wood Flooring Works in Delhi - India"
          />
          <meta
