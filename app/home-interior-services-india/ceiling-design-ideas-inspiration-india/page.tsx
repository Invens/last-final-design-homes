...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Ceiling Designs | Ceiling Works in Delhi - India'
  )
  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>Ceiling Designs | Ceiling Works in Delhi - India</title>

          <meta
            name="description"
            content="we manufacture custom ceilings like glass, POP, wooden, gypsum and bamboo as per interior design, we execute affordable ceiling works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/ceiling-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/ceiling-designs/"
          />
          <meta
            property="og:title"
            content="Ceiling Designs | Ceiling Works in Delhi - India"
          />
          <meta
