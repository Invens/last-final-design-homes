...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Wall Paint Interiors | Paint Contractors in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is a Top interior designing, architectural & Civil contractual brand, we execute affordable wall paint works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/paint-works-interiors/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/paint-works-interiors/"
          />
          <meta
            property="og:title"
            content="Wall Paint Interiors | Paint Contractors in Delhi - India"
          />
          <meta
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Painting Services</span>
        </div>
