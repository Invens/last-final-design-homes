...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [46]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Wooden Flooring Designs | Wood Flooring Works in Delhi - India</title>

<meta name="description" content ="Our brand is Best interior designing, architectural & Civil contractual brand, we execute affordable wooden flooring works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/wooden-flooring-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/wooden-flooring-designs/" />
<meta property="og:title" content="Wooden Flooring Designs | Wood Flooring Works in Delhi - India" />
<meta property="og:description" content="Our brand is Best interior designing, architectural & Civil contractual brand, we execute affordable wooden flooring works across Delhi - NCR & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Vertical Garden</span>
        </div>
