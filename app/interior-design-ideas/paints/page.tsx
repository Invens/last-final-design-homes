...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [60]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Wall Paint Interiors | Paint Contractors in Delhi - India</title>

<meta name="description" content ="Our brand is a Top interior designing, architectural & Civil contractual brand, we execute affordable wall paint works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/paint-works-interiors/" />
...
<meta property="og:url" content="https://designindianhomes.com/paint-works-interiors/" />
<meta property="og:title" content="Wall Paint Interiors | Paint Contractors in Delhi - India" />
<meta property="og:description" content="Our brand is a Top interior designing, architectural & Civil contractual brand, we execute affordable wall paint works across Delhi - NCR & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Paints</span>
        </div>
