...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [57]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Wooden Door Designs | Door Manufacturers in Delhi - India</title>

<meta name="description" content ="Our brand is a top interior designing, architectural & Civil contractual brand, we manufacture and deal in wooden doors across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/wood-door-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/wood-door-designs/" />
<meta property="og:title" content="Wooden Door Designs | Door Manufacturers in Delhi - India" />
<meta property="og:description" content="Our brand is a top interior designing, architectural & Civil contractual brand, we manufacture and deal in wooden doors across Delhi - NCR & India" />
