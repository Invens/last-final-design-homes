...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [53]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Glass Partition Designs | Glass Partition Manufacturers</title>

<meta name="description" content ="Our brand is largest interior designing, architectural & Civil contractual brand, we deal in affordable glass partition works across Delhi - NCR & India" />
...
<meta property="og:title" content="Glass Partition Designs | Glass Partition Manufacturers"/>
<meta property="og:description" content="Our brand is largest interior designing, architectural & Civil contractual brand, we deal in affordable glass partition works across Delhi - NCR & India" />
        </Head>
        {/* breadcrumb */}
        <div className="p-4  ">
