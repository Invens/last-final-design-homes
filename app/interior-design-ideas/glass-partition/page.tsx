    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is largest interior designing, architectural & Civil contractual brand, we deal in affordable glass partition works across Delhi - NCR & India"
          />
          ...
          <meta
            property="og:title"
            content="Glass Partition Designs | Glass Partition Manufacturers"
          />
          <meta
