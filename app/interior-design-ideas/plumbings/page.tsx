  ...
  return (
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          <title>
            Plumbing Works Designs | Plumbing Contractors in Delhi - NCR
          </title>
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/plumbing-works-interiors/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/plumbing-works-interiors/"
          />
          <meta
            property="og:title"
            content="Plumbing Works Designs | Plumbing Contractors in Delhi - NCR"
          />
          <meta
            property="og:description"
            content="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable plumbing works across Delhi - NCR & India"
          />
        </head>
        {/* breadcrumb */}
        <div className="p-4  ">
