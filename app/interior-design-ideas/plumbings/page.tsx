  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Plumbing Works Designs | Plumbing Contractors in Delhi - NCR</title>
...
<link rel="canonical" href="https://designindianhomes.com/plumbing-works-interiors/" />
...
<meta property="og:url" content="https://designindianhomes.com/plumbing-works-interiors/" />
<meta property="og:title" content="Plumbing Works Designs | Plumbing Contractors in Delhi - NCR" />
<meta property="og:description" content="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable plumbing works across Delhi - NCR & India" />
        </Head>
        {/* breadcrumb */}
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Plumbings</span>
        </div>
