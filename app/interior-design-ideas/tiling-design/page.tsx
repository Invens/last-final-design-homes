...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [49]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Tiling Designs | Floor Tiling Works in Delhi - India</title>

<meta name="description" content ="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable tiling works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/tiling-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/tiling-designs/" />
<meta property="og:title" content="Tiling Designs | Floor Tiling Works in Delhi - India" />
<meta property="og:description" content="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable tiling works across Delhi - NCR & India" />
        </Head>
        {/* breadcrumb */}
        <div className="p-4  ">
