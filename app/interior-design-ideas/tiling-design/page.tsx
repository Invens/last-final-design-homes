...
const Page = ({}) => {
  ...
  const [title, setTitle] = useState(
    'Tiling Designs | Floor Tiling Works in Delhi - India'
  )
    ...
    <>
      ...
      <div className="mt-24 lg:mt-36 mb-16 mx-auto sm:mx-16">
        <head>
          ...
          <meta
            name="description"
            content="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable tiling works across Delhi - NCR & India"
          />
          ...
          <link
            rel="canonical"
            href="https://designindianhomes.com/tiling-designs/"
          />
          ...
          <meta
            property="og:url"
            content="https://designindianhomes.com/tiling-designs/"
          />
          <meta
            property="og:title"
            content="Tiling Designs | Floor Tiling Works in Delhi - India"
          />
          <meta
