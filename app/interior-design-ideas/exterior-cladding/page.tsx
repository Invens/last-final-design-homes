...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [56]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Exterior Cladding Designs | Exterior Cladding in Delhi - India</title>

<meta name="description" content ="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable exterior cladding works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/exterior-cladding-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/exterior-cladding-designs/" />
<meta property="og:title" content="Exterior Cladding Designs | Exterior Cladding in Delhi - India" />
<meta property="og:description" content="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable exterior cladding works across Delhi - NCR & India" />
        </Head>
        {/* breadcrumb */}
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Exterior Cladding</span>
        </div>
