...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [48]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>UPVC Window Designs | UPVC Door Works in Delhi - India</title>

<meta name="description" content ="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable upvc window and door works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/upvc-windows-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/upvc-windows-designs/" />
<meta property="og:title" content="UPVC Window Designs | UPVC Door Works in Delhi - India" />
<meta property="og:description" content="Our brand is top interior designing, architectural & Civil contractual brand, we execute affordable upvc window and door works across Delhi - NCR & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">UPVC Windows</span>
        </div>
