...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [55]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Wall Panelling Designs | Wall Panelling in Delhi - NCR India</title>

<meta name="description" content ="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable wall panelling works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/wall-panelling/" />
...
<meta property="og:url" content="https://designindianhomes.com/wall-panelling/" />
<meta property="og:title" content="Wall Panelling Designs | Wall Panelling in Delhi - NCR India"/>
<meta property="og:description" content="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable wall panelling works across Delhi - NCR & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Wall Panelling</span>
        </div>
