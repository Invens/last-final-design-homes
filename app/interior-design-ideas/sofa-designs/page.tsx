...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [50]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Sofa Designs | Sofa Dealers & Manufacturers in Delhi - India</title>

<meta name="description" content ="Our brand is largest manufacturer for sofas and custom furniture, we deal in affordable sofa works across Delhi - NCR & India." />
...
<link rel="canonical" href="https://designindianhomes.com/sofa-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/sofa-designs/" />
<meta property="og:title" content="Sofa Designs | Sofa Dealers & Manufacturers in Delhi - India" />
<meta property="og:description" content="Our brand is largest manufacturer for sofas and custom furniture, we deal in affordable sofa works across Delhi - NCR & India." />
        </Head>
        {/* breadcrumb */}
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Sofa designs</span>
        </div>
