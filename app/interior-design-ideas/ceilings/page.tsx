...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [54]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head><title>Ceiling Designs | Ceiling Works in Delhi - India</title>

<meta name="description" content ="we manufacture custom ceilings like glass, POP, wooden, gypsum and bamboo as per interior design, we execute affordable ceiling works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/ceiling-designs/" />
...
<meta property="og:url" content="https://designindianhomes.com/ceiling-designs/" />
<meta property="og:title" content="Ceiling Designs | Ceiling Works in Delhi - India" />
<meta property="og:description" content="we manufacture custom ceilings like glass, POP, wooden, gypsum and bamboo as per interior design, we execute affordable ceiling works across Delhi - NCR & India" />
</Head>
        {/* breadcrumb */}
        <div className="p-4  ">
