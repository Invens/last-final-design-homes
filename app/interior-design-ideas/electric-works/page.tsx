...
const Page = ({}) => {
  ...
  useEffect(() => {
    const categoryIds = [58]; // Add the category IDs you want to fetch
  ...
  return (
    <>
      ...
      <div className="mt-32 lg:mt-64 mb-16 mx-auto mx-8 sm:mx-16">
        <Head>
        <title>Electrical Works | MEP | Electric Works in Delhi - India</title>

<meta name="description" content ="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable electrical works across Delhi - NCR & India" />
...
<link rel="canonical" href="https://designindianhomes.com/electric-works-interiors/" />
...
<meta property="og:url" content="https://designindianhomes.com/electric-works-interiors/" />
<meta property="og:title" content="Electrical Works | MEP | Electric Works in Delhi - India" />
<meta property="og:description" content="Our brand is largest interior designing, architectural & Civil contractual brand, we execute affordable electrical works across Delhi - NCR & India" />
        ...
        <div className="p-4  ">
          ...
          / <span className="text-gray-600 text-sm">Electric Works</span>
        </div>
